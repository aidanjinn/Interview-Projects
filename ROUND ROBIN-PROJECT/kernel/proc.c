...
proc_pagetable(struct proc *p)
{
  ...
  // map the usyscall page just below the trapframe for read-only
  // shared access to memory structures by both the kernel and userspace
...
fork(void)
{
  ...
  //copy priority level from parent to child
